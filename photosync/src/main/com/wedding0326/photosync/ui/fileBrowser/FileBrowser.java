...
public class FileBrowser {
    ...
    // private final String[] tableTitles = new String[] { FileBrowser.getResourceString("table.Name.title"),
    // FileBrowser.getResourceString("table.Size.title"), FileBrowser.getResourceString("table.Type.title"),
    ...
    // /**
    // * Returns a string from the resource bundle. We don't want to crash because of a missing String. Returns the key
    // if
    // * not found.
    // */
    //
    // /**
    // * Returns a string from the resource bundle and binds it with the given arguments. If the key is not found,
    // return
    // * the key.
    // */
    ...
    void notifySelectedFiles(File[] files) {
        ...
        if ((files != null) && (files.length != 0)) {
            // numObjectsLabel.setText(getResourceString("details.NumberOfSelectedFiles.text", new Object[] { new
            // Integer(
            // files.length) }));
            long fileSize = 0L;
            ...
            if (currentDirectory != null) {
                ...
                // numObjectsLabel.setText(getResourceString("details.DirNumberOfObjects.text", new Object[] { new
                // Integer(
                // numObjects) }));
            } else {
